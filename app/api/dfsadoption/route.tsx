...
export async function POST(request: any) {
  ...
  const toEmail = process.env.NEXT_PUBLIC_ADOPTION_FORM_EMAIL
  const toEmailCC = process.env.NEXT_PUBLIC_ADOPTION_FORMCC_EMAIL
  ...
  try {
    const mail = await transporter.sendMail({
      from: `"Karandaaz - Application for Adoption & Continuous Improvement Form Submission" <${senderEmail}>`,
      to: toEmail,
      cc: toEmailCC,
      subject: `Application for Adoption & Continuous Improvement`,
      html: `
    ...
    const sheetTitle = 'Adoption & Continuous Improvement'
