...
export default async function PrivateSectorEngagements({ params }: any) {
  const res = await getDigitalSubUrlField('digital-privatesectorengagements-challengerounds-dfa', params.lang)
  const resSubfields = await getChallangeRoundSubUrlField(
    'digital-privatesectorengagements-challengerounds-dfa',
    params.lang
  )
    ...
    <main className='dfacpage'>
      <section className='section-py-md'>
        <TopHeaderSection
          ...
          proposalTemplate='https://krndevelop.wpenginepowered.com/wp-content/uploads/2025/03/DFAC-2-Proposal-Template.docx'
