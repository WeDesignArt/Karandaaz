...
import { digitalPrivateSectorEngagementsUrl } from '../../../../../utils/urls'
...
export default async function PrivateSectorEngagements({ params }: any) {
  const res = await getDigitalSubUrlField('digital-privatesectorengagements-pilottoscale', params.lang)
  const footerRes = await getFooter('pilot-to-scale', params.lang)
  ...
  return (
    <main>
      ...
      <section className='section-py-md' id='section6'>
        <div className='container'>
          <div className='row'>
            <div className='col-md-12'>
              <h3 className='text-center mb-5'>Apply Now</h3>
              <p className='text-center'>
                Please do mention the respective domain under which you wish to apply for grant in the subject line of
                your email along with a deck of slides or a PDF containing an initial proposal as an attachment and send
                to <a href='mailto: programofficedfs@karandaaz.com.pk'>programofficedfs@karandaaz.com.pk</a>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* <section className='section-py-md'>
        <div className='container'>
          <div className='row'>
            <div className='col-md-12'>
              <h3 className='text-center mb-5'>{footerRes?.title}</h3>
