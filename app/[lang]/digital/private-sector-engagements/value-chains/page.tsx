...
export default async function PrivateSectorEngagements({ params }: any) {
  const res = await getDigitalSubUrlField('digital-privatesectorengagements-valuechains', params.lang)
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-12'>
              <h2 className='text-center mb-3 mb-md-5'>{digitalExtra?.headingnew}</h2>
              <div className='p-5 br-r20 bg-blue00'>{digitalExtra?.description}</div>
            </div>
          </div>
        </div>
      </section> */}
