...
export async function generateMetadata({ params }: any) {
  const res = await getDigitalSubUrlField('digital-publicinfrastructure', params.lang)
  const title = `Karandaaz Digital: Leading Pakistan's Digital Finance Revolution`
  const description = `Karandaaz is spearheading the shift to digital finance in Pakistan. Learn about our collaborations with key institutions to enhance financial inclusion and economic growth in Pakistan.`
  return {
    ...
    openGraph: {
      ...
      url: `${process.env.KRN_BASE_URL}/digital/digital-public-infrastructure`,
